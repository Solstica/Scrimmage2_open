...
\begin{document}
	...
	图\ref{fig:spec_15}展示了 $15^\circ$ 入射角的原始反射率光谱。可以看出反射率在 $2500\sim3300\ \mathrm{cm^{-1}}$ 波段呈现明显的周期性振荡，这是外延层上下界面反射光干涉的结果，振荡周期与光学厚度 $nd$ 直接相关。振荡幅度约为 $20\%$，基线反射率约 $15\%$，符合SiC在红外波段的典型反射特征。$10^\circ$ 入射角的原始光谱具有类似特征，但振荡相位略有差异，这为多角度约束厚度提供了互补信息。
	
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.8\textwidth]{02_15度原始光谱.png}
		\caption{$15^\circ$ 入射角下SiC外延层的原始反射率光谱}
		\label{fig:spec_15}
	\end{figure}
